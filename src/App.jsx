...
const IconFlower = () => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 2a3 3 0 0 1 3 3c0 1.5-1 2.5-1 3.5"/>
    <path d="M12 2a3 3 0 0 0-3 3c0 1.5 1 2.5 1 3.5"/>
    <path d="M22 12a3 3 0 0 1-3 3c-1.5 0-2.5-1-3.5-1"/>
    <path d="M22 12a3 3 0 0 0-3-3c-1.5 0-2.5 1-3.5 1"/>
    <path d="M12 22a3 3 0 0 1-3-3c0-1.5 1-2.5 1-3.5"/>
    <path d="M12 22a3 3 0 0 0 3-3c0-1.5-1-2.5-1-3.5"/>
    <path d="M2 12a3 3 0 0 1 3-3c1.5 0 2.5 1 3.5 1"/>
    <path d="M2 12a3 3 0 0 0 3 3c1.5 0 2.5-1 3.5-1"/>
  </svg>
);
...
function ThemeToggle({ theme, onChange }) {
  const opts = [
    ...
    { id: 'lc',    icon: <IconFlower />, label: 'Las Cafeteras' },
  ];
  return (
...
export default function App(){
    ...
    (async () => {
      try {
        ...
        for (const p of PRESET_CALENDARS) {
          if (p.requiresAuth && !appPassword) continue;
          try {
  ...
  // Load personal calendar after unlock
  useEffect(() => {
